...
Once you have researched Rail Signals a new button will show up. Press the button which will expand the list.  
...
Be warned, if the player is not safe he can die, you can also run her over with the train you are remotely controlling. [i]You have been warned
